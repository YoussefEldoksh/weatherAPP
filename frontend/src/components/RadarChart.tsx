...
function WeatherRadar({ currentData, forecast }: Props) {
    ...
    return (
        <div className="bg-white h-[350px] flex justify-center p-6 rounded-xl shadow-2xl font-sora">
            <ResponsiveContainer width="100%" height="100%">
                <RadarChart data={radarData} margin={{ top: 10, right: 30, bottom: 10, left: 30 }}>          <PolarGrid stroke="#0000FF" />
                    <PolarAngleAxis
                        dataKey="metric"
